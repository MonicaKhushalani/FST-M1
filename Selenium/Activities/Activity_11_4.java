...
public class Activity_11_4 {
    public static void main(String[] args) {
        ...
        //String newTabText = driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div")).getText();
        ...
        driver.findElement(By.xpath("//a[contains(text(),'Open Another One!')]")).click();
